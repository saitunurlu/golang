...
type Controllers struct {
	...
	CategorysController *controllers.CategorysController
...
func SetupCollectionRoutes(router *gin.Engine, controllers Controllers) {
	...
	// Categorys collection endpoints
	// Insert
	router.POST("api/v1/categorys/:id", controllers.CategorysController.InsertDocumentForCategorys())
	// Get
	router.GET("api/v1/categorys/list", controllers.CategorysController.GetDocumentForCategorys())
