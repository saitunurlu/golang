...
func main() {
	...
	categorysService := services.NewCategorysService(scope)
	...
	categorysController := controllers.NewCategorysController(categorysService)
	...
	fmt.Println("The application is running on http://127.0.0.1:8081 ")
	router.Run(":8081")
}
